...
def extract_deck_info(deck, cards):
    ...
    info["skills_q"] = 0
    info["treachery_q"] = 0
    info["assets_permanents_q"] = 0
    info["xp"] = 0
    info["color"] = get_color_by_investigator(deck, cards)
    info["taboo_id"] = "00" + str(deck["taboo_id"]) if deck["taboo_id"] else "000"
