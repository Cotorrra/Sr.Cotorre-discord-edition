from src.core.formating import format_name, format_subtext, format_faction, format_card_text, \
    format_victory, format_illus_pack, create_embed, format_flavour, format_type, \
    format_traits
from src.core.utils import text_if
from src.api_interaction.errata import errata
from src.p_cards.utils import format_customizable, format_customizable_note, format_slot, format_skill_icons, format_health_sanity, \
    format_inv_skills, format_costs
